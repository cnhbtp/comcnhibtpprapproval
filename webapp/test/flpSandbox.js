		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PR Approval",
									"targetURL": "#comcnhibtpprapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcnhibtpprapproval-display": {
								"semanticObject": "comcnhibtpprapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.cnhi.btp.prapproval",
									"url": sap.ui.require.toUrl("com/cnhi/btp/prapproval")
								}
							}
						}
					}
